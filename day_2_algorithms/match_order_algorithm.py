...
class Trader:
    ...
    def run(self, state: TradingState) -> Dict[str, List[Order]]:
        ...
        positionLimits = {"PINA_COLLADA": 20, "COCONUTS": 20}
        productValuations = {"PINA_COLLADA": 15000, "COCONUTS": 8000}
...
def get_product_valuations(market_trades):
    ...
    for product in market_trades.keys():
        ...
        predicted_prices[product] = transaction_totals/quantity_traded - 100
